...
// Argument defaults
$esid = $spid = $sip = $spt = $dip = $dpt = $stime = $etime = $usr = $pwd = $sancp = $event = $elsa = $bro = $tcpflow = $pcap = $maxtx = $filename = $parameters = '';
...
// Validate user input - spid
if (isset($_REQUEST['spid']))      {
                $spid    = $_REQUEST['spid'];      $s++;
        $parameters .= "&spid=" . $spid;
}

// Validate user input - sourcetype
if (isset($_REQUEST['stype']))      {
                $stype    = $_REQUEST['stype'];      $s++;
