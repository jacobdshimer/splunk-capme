...
<script type="text/javascript" src=".js/splunk.js"></script>
</head>
...
<input type=text maxlength=38 id=spid class=capme_selb value="<?php echo $spid;?>" /> 
</td>
</tr>
...
<tr>
<td class=capme_left>Sourcetype:</td>
<td class=capme_right>
<input type=text maxlength=38 id=stype class=capme_selb value="<?php echo $stype;?>" /> 
</td>
</tr>
